...
import net.runelite.blessedscripts.wrappers.subwrap.ChooseOption;
import net.runelite.blessedscripts.wrappers.subwrap.NPCChat;
...
/**
 * Provides access to methods that can be used by BlessedScripts scripts.
 */
public class Methods {
	...
	/**
	 * Prints to the BlessedScripts log.
	 *
	...
	/**
	 * Prints to the BlessedScripts log with a font color
	 *
