...
import net.runelite.blessedscripts.internal.globval.VarpIndices;
import net.runelite.blessedscripts.internal.globval.GlobalWidgetInfo;
import net.runelite.blessedscripts.internal.globval.VarpValues;
import net.runelite.blessedscripts.internal.globval.WidgetIndices;
import net.runelite.blessedscripts.internal.globval.enums.InterfaceTab;
import net.runelite.blessedscripts.internal.globval.enums.MagicBook;
import net.runelite.blessedscripts.internal.globval.enums.Spell;
import net.runelite.blessedscripts.wrappers.RSCharacter;
