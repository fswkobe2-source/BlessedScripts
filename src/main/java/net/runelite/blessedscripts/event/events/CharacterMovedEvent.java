package net.runelite.blessedscripts.event.events;

import net.runelite.blessedscripts.methods.MethodContext;
import net.runelite.blessedscripts.event.EventMulticaster;
...
public class CharacterMovedEvent extends RSEvent {
	...
	private final net.runelite.blessedscripts.wrappers.RSCharacter wrapped;
	...
	public net.runelite.blessedscripts.wrappers.RSCharacter getCharacter() {
		if (wrapped == null) {
			if (character instanceof net.runelite.api.NPC) {
				final net.runelite.api.NPC npc = (net.runelite.api.NPC) character;
				wrapped = new net.runelite.blessedscripts.wrappers.RSNPC(ctx, npc);
				...
				wrapped = new net.runelite.blessedscripts.wrappers.RSPlayer(ctx, player);
			}
		}
		return wrapped;
	}
