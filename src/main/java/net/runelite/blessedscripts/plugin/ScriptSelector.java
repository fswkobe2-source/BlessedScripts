package net.runelite.blessedscripts.plugin;
...
import net.runelite.blessedscripts.internal.listener.ScriptListener;
import net.runelite.blessedscripts.script.Script;
import net.runelite.blessedscripts.service.FileScriptSource;
import net.runelite.blessedscripts.service.ScriptDefinition;
import net.runelite.blessedscripts.service.ScriptSource;
import net.runelite.blessedscripts.service.ServiceException;
...
import static net.runelite.blessedscripts.util.StringUtil.convertIntelliJPath;
...
public class ScriptSelector extends JDialog implements ScriptListener {
	...
	static String TEST_PATH = convertIntelliJPath(net.runelite.blessedscripts.testsScript.Test.class, "Test.class");
