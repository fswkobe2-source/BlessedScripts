package net.runelite.blessedscripts.testsScript;

import net.runelite.api.Point;
import net.runelite.blessedscripts.botLauncher.RuneLiteTestFeatures;
...
import net.runelite.blessedscripts.util.StdRandom;
