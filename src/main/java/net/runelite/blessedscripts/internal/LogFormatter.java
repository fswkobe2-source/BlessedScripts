...
public class LogFormatter extends Formatter {
	...
	public String format(LogRecord record) {
		StringBuilder result = new StringBuilder().append("[").append(record.getLevel().getName()).append("] ").
				...
				append(record.getMessage()).append(net.runelite.blessedscripts.util.StringUtil.throwableToString(record.getThrown()));
		if (appendNewLine) {
	...
	public String formatError(LogRecord record) {
		return net.runelite.blessedscripts.util.StringUtil.throwableToString(record.getThrown());
	}
