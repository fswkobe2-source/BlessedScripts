...
import net.runelite.blessedscripts.internal.listener.DebugSettingsListener;
import net.runelite.blessedscripts.script.Script;
import net.runelite.blessedscripts.script.ScriptManifest;
import net.runelite.blessedscripts.internal.listener.ScriptListener;
import net.runelite.blessedscripts.script.randoms.LoginBot;

import java.util.*;

public class ScriptHandler {

	private final ArrayList<net.runelite.blessedscripts.script.Random> randoms = new ArrayList<>();
	...
	public void init() {
		...
		for (net.runelite.blessedscripts.script.Random r : randoms) {
	...
	public Collection<net.runelite.blessedscripts.script.Random> getRandoms() {
		return randoms;
	}
