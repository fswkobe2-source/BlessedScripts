...
public class GlobalConfiguration {
	...
	public static class Paths {
		...
		public static class Resources {
			public static final String ROOT = "../../../net.runelite.blessedscripts";
			public static final String ROOT_IMG = ROOT ;//+ "/images";
			public static final String ICON = GlobalConfiguration.class.getResource("blessedscripts/plugin/blessedscripts.png").getPath();
			public static final String VERSION = ROOT + "/version.txt";
		}

		public static class URLs {
			private static final String BASE = "https://github.com/BlessedScripts/";
			public static final String FORUMS = "https://blessedscripts.org/";
			...
			public static final String PROJECT = BASE + "BlessedScripts";
			public static final String VERSION = BASE + PROJECT +"/version.txt";
			public static final String SITE = BASE + "BlessedScriptsSite-PlaceHolder-";
		 ...
		 */
		public static String getBlessedScriptsDirectory() {
		...
		public static String getLogsDirectory() {
			return Paths.getBlessedScriptsDirectory() + File.separator + "Logs";
		}
		...
		public static String getScreenshotsDirectory() {
			return Paths.getBlessedScriptsDirectory() + File.separator + "Screenshots";
		}

		public static String getScriptsDirectory() {
			return Paths.getBlessedScriptsDirectory() + File.separator + Paths.SCRIPTS_NAME_OUT;
		}
		...
		public static String getCacheDirectory() {
			return Paths.getBlessedScriptsDirectory() + File.separator + "Cache";
		}
		...
		public static String getSettingsDirectory() {
			return Paths.getBlessedScriptsDirectory() + File.separator + "Settings";
		}
	...
	public static final String NAME = "BlessedScripts";
	...
	static {
		...
		dirs.add(Paths.getBlessedScriptsDirectory());
