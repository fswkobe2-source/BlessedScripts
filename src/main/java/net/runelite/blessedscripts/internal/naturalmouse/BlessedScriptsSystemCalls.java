package net.runelite.blessedscripts.internal.naturalmouse;
...
public class BlessedScriptsSystemCalls implements SystemCalls {
    InputManager inputManager;
    public BlessedScriptsSystemCalls(InputManager inputManager) {
