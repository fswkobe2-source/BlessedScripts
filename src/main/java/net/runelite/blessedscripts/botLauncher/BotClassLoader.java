    ...
    private static class ChildClassLoader extends ClassLoader
    {
        ...
        public Class<?> findClass(String name) throws ClassNotFoundException
        {
            ...
            try {
                ...
                if (name.equals("net.runelite.blessedscripts.botLauncher.BotLiteInterface") ||
                    name.startsWith("net.runelite.blessedscripts.internal.globval.GlobalConfiguration") ||
