...
import net.runelite.blessedscripts.event.EventManager;
import net.runelite.blessedscripts.event.events.PaintEvent;
import net.runelite.blessedscripts.event.events.TextPaintEvent;
import net.runelite.blessedscripts.internal.BreakHandler;
import net.runelite.blessedscripts.internal.InputManager;
...
import net.runelite.blessedscripts.internal.input.Canvas;
import net.runelite.blessedscripts.methods.Environment;
import net.runelite.blessedscripts.methods.MethodContext;
import net.runelite.blessedscripts.plugin.AccountManager;
import net.runelite.blessedscripts.plugin.ScriptSelector;
