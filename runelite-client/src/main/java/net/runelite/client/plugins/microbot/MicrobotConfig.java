...
public interface MicrobotConfig extends Config
{
	...
	String keyEnableAutoSetup = "enableAutoSetup";
	...
	@ConfigItem(
		keyName = "enableAutoSetup",
		name = "Enable Auto-Setup",
		description = "Allow automatic interface handling and mouse control on login (welcome screen, tutorials, etc.)",
		position = 0,
		section = generalSection
	)
	default boolean enableAutoSetup()
	{
		return false;
	}
