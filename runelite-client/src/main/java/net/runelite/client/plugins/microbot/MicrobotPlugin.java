...
@PluginDescriptor(
	name = PluginDescriptor.Default + "Blessed Scripts",
	description = "Blessed Scripts",
...
public class MicrobotPlugin extends Plugin
{
	...
	{
		log.info("Blessed Scripts: {} - {}", RuneLiteProperties.getBlessedScriptsVersion(), RuneLiteProperties.getBlessedScriptsCommit());
